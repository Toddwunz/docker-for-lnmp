...
menu(){ 
        ...
        echo "执行前，先下载把jdk1.8的rpm包到/root/mycat目录，重命名为：jdk1.8.rpm  "
        echo -e "\033[31;32m============================================================================\033[0m"
        echo
...
<mycat:schema xmlns:mycat="http://io.mycat/">
        ...
        <dataHost name="localhost1" maxCon="2000" minCon="1" balance="1"
            ...
            <writeHost host="hostMaster" url="192.168.10.102:3306" user="wpuser" password="123456">
                  <!-- can have multi read hosts -->
                  <readHost host="hostSlave" url="192.168.10.102:3307" user="wpuser" password="123456" />
            </writeHost>
        </dataHost>
</mycat:schema>
EOF
